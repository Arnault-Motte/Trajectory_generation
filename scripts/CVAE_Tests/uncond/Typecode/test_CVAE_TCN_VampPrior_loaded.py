...
def main() -> int:
    ...
    displayer.plot_distribution_typecode_label_generation("data_orly/figures/vertical_rates_recons/CVAE_TCN_vamp_sampled_vr_dist_1_Take_off_7.png","data_orly/figures/vertical_rates_recons/CVAE_TCN_vamp_sampled_vr_dist_2_Take_off_7.png",model,2000,True,(0,4000))
