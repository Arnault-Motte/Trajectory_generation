...
def main() -> int:
    ...
    displayer.plot_distribution_typecode(
        "data_orly/figures/vertical_rates_recons/CVAE_TCN_vamp_og_take_off_7_vr_direct_cond_1.png",
        "data_orly/figures/vertical_rates_recons/CVAE_TCN_vamp_og_take_off_7_vr_direct_cond_2.png",
        hist=True,
    )
    ...
    displayer.plot_v_rate_true_top_generated(
        "data_orly/figures/vertical_rates_recons/CVAE_TCN_vamp_Recons_take_off_7_cond_compare_vr.png",
        2000,
        model,
    )

    print("shanon: ", displayer.return_label_shanon())
    return 0
