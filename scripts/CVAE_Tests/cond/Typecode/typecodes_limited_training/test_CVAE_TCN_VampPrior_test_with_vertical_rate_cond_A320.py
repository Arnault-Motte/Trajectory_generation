...
def main() -> int:
    ...
    displayer.plot_compare_traffic(traffic_init,traffic_f,2000,plot_path="data_orly/figures/generation/rec_VAE_Vamp_w_vr_A320.png")
    
    gen = Generator(None,data_cleaner,model)

    traff = gen.generate_n_flight(2000,500)
    displayer.plot_traffic(traffic=traff, plot_path="data_orly/figures/generation/VAE_Vamp_w_vr_A320.png")
    return 0
