...
def main() -> int:
    ...
    traffic_f.data.to_pickle(
        "data_orly/generated_traff/reproducted/CAE_TCN_Vamp_reproducted_traff_take_off_7_vr_direct_B738_A320.pkl"
    )
    # print(data_cleaner.first_n_flight_delta_time(traffic_f))

    displayer.plot_distribution_typecode_label_generation(
        "data_orly/figures/vertical_rates_recons/CVAE_TCN_vamp_Recons_take_off_7_vr_direct_cond_1_B738_A320.png",
        "data_orly/figures/vertical_rates_recons/CVAE_TCN_vamp_Recons_take_off_7_vr_direct_cond_2_B738_A320.png",
        model,
        hist=True,
        bounds=(0, 4000),
    )
