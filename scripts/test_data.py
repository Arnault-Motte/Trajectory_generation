...
def main() -> int:
    ...
    displayer.plot_distribution_typecode('/home/arnault/traffic/data_orly/figures/airplane_models_distrib_stacked_take_off_7.png','/home/arnault/traffic/data_orly/figures/airplane_models_distrib_take_off_7.png',False)
