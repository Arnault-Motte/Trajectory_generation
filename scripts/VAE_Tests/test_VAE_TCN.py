...
from data_orly.src.generation.models.VAE_TCN import *  # noqa: F403
...
def main()->int:
    ...
    displayer.plot_compare_traffic(traffic_init, traffic_f,plot_path="data_orly/figures/VAE_TCN_Recons.png")  # noqa: E501
    traffic_f.data.to_pickle('data_orly/generated_traff/reproducted/VAE_TCN_reproducted_traff.pkl')
    print(data_cleaner.first_n_flight_delta_time(traffic_f))
    model.save_model("data_orly/src/generation/models/saved_weights/VAE_TCN.pth")
    return 0
