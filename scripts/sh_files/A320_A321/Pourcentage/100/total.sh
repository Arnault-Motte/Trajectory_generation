...
uv run python data_orly/scripts/script_train/train_CVAE.py --data data_orly/data/takeoffs_LFPO_07.pkl --weights data_orly/src/generation/models/saved_weights/limited_one_typecode/A320_A321/100/CVAE_both_A320_A321_all2.pth --typecodes A320 A321 --num_flights 1.0 1.0 --data_save data_orly/data/sampled_data/combined_data/A320_A321_all2.pkl --cuda 0 --scale 1 --balanced 1 --weights_data 0 --pseudo_in 400 --l_dim 64
