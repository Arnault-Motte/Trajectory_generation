...
# uv run python data_orly/scripts/script_train/train_CVAE.py --data data_orly/data/sampled_data/combined_data/A320_A321_all.pkl --weights data_orly/src/generation/models/saved_weights/limited_one_typecode/A320_A321/50/CVAE_both_A320_A321_50.pth --typecodes A320 A321 --num_flights 1.0 0.5 --data_save data_orly/data/sampled_data/combined_data/A320_A321_50.pkl --cuda 1 --scale 0.9 --balanced 0
# uv run python data_orly/scripts/script_train/train_VAE.py --data data_orly/data/sampled_data/combined_data/A320_A321_50.pkl --weights data_orly/src/generation/models/saved_weights/limited_one_typecode/A320_A321/50/VAE_A321_50.pth --typecodes A321 --cuda 1 --scale 0.5
