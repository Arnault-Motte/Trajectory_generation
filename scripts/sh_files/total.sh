...
# uv run python data_orly/scripts/script_train/train_CVAE.py --data data_orly/data/takeoffs_LFPO_07.pkl --weights data_orly/src/generation/models/saved_weights/limited_one_typecode/CVAE_both_A320_A321_200.pth --typecodes A320 A321 --num_flights -1 200 --data_save data_orly/data/sampled_data/combined_data/A320_A321_200.pkl --cuda 0 --scale 1
