...
# uv run data_orly/scripts/loss/loss_compute.py --model data_orly/src/generation/models/saved_weights/limited_one_typecode/B738_A320/50/CVAE_both_B738_A320_50.pth --file  data_orly/data/sampled_data/combined_data/B738_A320_50_2.pkl --typecode B738 --typecodes B738 A320 --cond 1 --loss_file data_orly/results/loss/B738_A320/50/loss.csv --origin data_orly/data/takeoffs_LFPO_07.pkl --cuda 1 --l_dim 32 --pseudo_in 600
# uv run data_orly/scripts/loss/loss_compute.py --model data_orly/src/generation/models/saved_weights/limited_one_typecode/B738_A320/50/CVAE_both_B738_A320_50.pth --file  data_orly/data/sampled_data/combined_data/B738_A320_50_2.pkl --typecode A320 --typecodes B738 A320 --cond 1 --loss_file data_orly/results/loss/B738_A320/50/loss.csv --origin data_orly/data/takeoffs_LFPO_07.pkl --cuda 1 --l_dim 32 --pseudo_in 600
