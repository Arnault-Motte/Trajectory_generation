...
uv run data_orly/scripts/Test_sim/scn_gen/data_scn_gen.py --navpoint_path "data_orly/temp_navp/tcvae_generation_navpoints.csv" --data "/data/data/arnault/data/final_data/TO_LFPO_test_final.pkl" --data_s /data/data/arnault/data/final_data/TO_LFPO_test_final_sub_samp3.pkl --scn_file data_orly/scripts/A_script_paper/scn/data3.scn --nf 40000 --typecodes  B738 A320 A321 A319 A20N A318 A21N #30000 files in total