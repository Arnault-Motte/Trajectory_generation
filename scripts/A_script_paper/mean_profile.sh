...
# uv run data_orly/scripts/A_script_paper/mean_profile.py  --onnx_cvae_dir data_orly/models_paper/CVAE_full_A320_0005_balanced_2000  --data /data/data/arnault/data/final_data/TO_LFPO_test_final.pkl --plot_path data_orly/figures/paper/compare_profile/final_plots/compare_profiles_CVAE_new_2000.png --typecodes  "${typecodes[@]}" --cond_pseudo 0


uv run data_orly/scripts/A_script_paper/mean_profile.py  --onnx_cvae_dir data_orly/models_paper/CVAE_5_A320_0005_cond  --data /data/data/arnault/data/final_data/TO_LFPO_test_final.pkl --plot_path data_orly/figures/paper/compare_profile/final_plots/compare_profiles_CVAE_pseudo_cond.png --typecodes  B738 A320 A321 A318 A21N --cond_pseudo 1
