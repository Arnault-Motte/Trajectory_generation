...
def main() -> None:
    ...
    parser.add_argument(
        "--log_file",
        type=str,
        default="/home/arnault/traffic/sim_logs/MY_LOG_LFPO7TRAF_20250407_10-19-14.log",
        help="Path of the log file",
    )
    parser.add_argument(
        "--ignored",
        type=str,
        default="/home/arnault/traffic/scn/LFPO_7_tst_denied_flight.pkl",
...
#
    ...
    print(len(distances))
    with open(
        "results/distances/" + args.saved_name,
        "wb",
    ) as file:
