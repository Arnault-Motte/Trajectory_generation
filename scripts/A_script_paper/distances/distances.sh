...
uv run python data_orly/scripts/Test_sim/scn_gen/plot_distance.py --og_traff /data/data/arnault/data/final_data/TO_LFPO_test_final_sub_samp2.pkl --true_dist "data_orly/scripts/A_script_paper/distances/A320/dist_total.pkl" --typecode B738 --labels VAE CVAE --save_path "data_orly/scripts/A_script_paper/distances/A320/distance_A320_plot.png" --file_paths  "data_orly/scripts/A_script_paper/distances/A320/A320_VAE_dist.pkl" "data_orly/scripts/A_script_paper/distances/A320/A320_CVAE_dist.pkl" 
