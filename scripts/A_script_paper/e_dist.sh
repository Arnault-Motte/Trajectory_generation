...
typecodes=( 'A321' 'A318' 'A21N' )
typecodes_use=('A321' 'A318' 'A21N')
list=()
for elem in "${typecodes_use[@]}"; do 
    list+=("data_orly/models_paper/VAE_${elem}_A320_010_3")
done
...
uv run data_orly/scripts/A_script_paper/e_dist.py --typecodes "${typecodes[@]}" --data_og "/data/data/arnault/data/final_data/TO_LFPO_test_final.pkl" --CVAE_ONNX data_orly/models_paper/CVAE_5_A320_0005_cond --dist_path data_orly/figures/paper/results/e_dist/distances_0005_cond.csv --cond_pseudo 1 --n_f 3000
