...
uv run data_orly/scripts/A_script_paper/vertical_rates_all_models.py --typecodes "${typecodes[@]}" --data_og "/data/data/arnault/data/final_data/TO_LFPO_test_final.pkl" --CVAE_ONNX data_orly/models_paper/CVAE_5_A320_0005_cond --plot_path data_orly/figures/paper/vertical_rates_comp_A320_0005_cond.png --VAEs_ONNX "${list[@]}" --n_f 5000 --cond_pseudo 1